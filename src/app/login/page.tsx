...
// Shadcn UI Components (Assuming you've initialized shadcn/ui)
// You might need to add these components to your project using the shadcn CLI:
        ...
        >
          <Card className="w-full max-w-md mx-4 shadow-2xl bg-white/80 backdrop-blur-sm dark:bg-gray-950/80">
            <CardHeader className="text-center">
              ...
              >
                <img src="https://placehold.co/80x80/7c3aed/ffffff?text=HRM" alt="Logo" className="rounded-full" />
              </motion.div>
              <CardTitle className="text-2xl font-bold text-gray-800 dark:text-gray-100">
                Home Rent Management
              </CardTitle>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                {error && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="flex items-center p-2 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800"
                  >
            ...
            <CardFooter className="flex justify-center">
                <p className="text-xs text-gray-500 dark:text-gray-400">
                    © {new Date().getFullYear()} Rent Management Inc. All rights reserved.
                </p>
            </CardFooter>
          </Card>
        </motion.div>
